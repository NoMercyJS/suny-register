...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        db.push(`isimler_${member.id}`, ` \`${name} | ${age}\` (<@&814482237814603826>)`);
        ...
        message.channel.send(embed2.setDescription(`${member} adlı kullanıcı\`${name} | ${age}\` isminde  kayıt edildi! (<@&814482237814603826>)`)
